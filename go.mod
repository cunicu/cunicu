...
require (
	...
	github.com/gopacket/gopacket v0.0.0-20220825100013-b6a42f7f20c5 // test-only
	github.com/onsi/ginkgo/v2 v2.1.4 // test-only
	github.com/onsi/gomega v1.20.1 // test-only
	github.com/stv0g/gont v1.6.3 // test-only
	sigs.k8s.io/controller-runtime v0.12.3 // test-only
)
