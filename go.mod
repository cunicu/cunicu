...
require (
	...
	github.com/gopacket/gopacket v0.1.0 // test-only
	github.com/onsi/ginkgo/v2 v2.6.0 // test-only
	github.com/onsi/gomega v1.24.1 // test-only
	github.com/stv0g/gont v1.6.3 // test-only
	sigs.k8s.io/controller-runtime v0.13.1 // test-only
)
