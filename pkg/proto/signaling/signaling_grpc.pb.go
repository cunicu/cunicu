...
type SignalingClient interface {
	...
	Subscribe(ctx context.Context, in *SubscribeParams, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Envelope], error)
...
func (c *signalingClient) GetBuildInfo(ctx context.Context, in *proto.Empty, opts ...grpc.CallOption) (*proto.BuildInfo, error) {
	...
	err := c.cc.Invoke(ctx, Signaling_GetBuildInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *signalingClient) Subscribe(ctx context.Context, in *SubscribeParams, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Envelope], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Signaling_ServiceDesc.Streams[0], Signaling_Subscribe_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[SubscribeParams, Envelope]{ClientStream: stream}
...
type Signaling_SubscribeClient = grpc.ServerStreamingClient[Envelope]

func (c *signalingClient) Publish(ctx context.Context, in *Envelope, opts ...grpc.CallOption) (*proto.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(proto.Empty)
	err := c.cc.Invoke(ctx, Signaling_Publish_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SignalingServer interface {
	...
	Subscribe(*SubscribeParams, grpc.ServerStreamingServer[Envelope]) error
...
func (UnimplementedSignalingServer) Subscribe(*SubscribeParams, grpc.ServerStreamingServer[Envelope]) error {
...
func _Signaling_Subscribe_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(SignalingServer).Subscribe(m, &grpc.GenericServerStream[SubscribeParams, Envelope]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Signaling_SubscribeServer = grpc.ServerStreamingServer[Envelope]
