...
type DaemonClient interface {
	...
	StreamEvents(ctx context.Context, in *proto.Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Event], error)
...
func (c *daemonClient) GetBuildInfo(ctx context.Context, in *proto.Empty, opts ...grpc.CallOption) (*proto.BuildInfo, error) {
	...
	err := c.cc.Invoke(ctx, Daemon_GetBuildInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daemonClient) StreamEvents(ctx context.Context, in *proto.Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Event], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Daemon_ServiceDesc.Streams[0], Daemon_StreamEvents_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[proto.Empty, Event]{ClientStream: stream}
...
func (c *daemonClient) UnWait(ctx context.Context, in *proto.Empty, opts ...grpc.CallOption) (*proto.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(proto.Empty)
	err := c.cc.Invoke(ctx, Daemon_UnWait_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daemonClient) Sync(ctx context.Context, in *proto.Empty, opts ...grpc.CallOption) (*proto.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(proto.Empty)
	err := c.cc.Invoke(ctx, Daemon_Sync_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daemonClient) SetConfig(ctx context.Context, in *SetConfigParams, opts ...grpc.CallOption) (*proto.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(proto.Empty)
	err := c.cc.Invoke(ctx, Daemon_SetConfig_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daemonClient) GetConfig(ctx context.Context, in *GetConfigParams, opts ...grpc.CallOption) (*GetConfigResp, error) {
	...
	err := c.cc.Invoke(ctx, Daemon_GetConfig_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daemonClient) GetCompletion(ctx context.Context, in *GetCompletionParams, opts ...grpc.CallOption) (*GetCompletionResp, error) {
	...
	err := c.cc.Invoke(ctx, Daemon_GetCompletion_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daemonClient) ReloadConfig(ctx context.Context, in *proto.Empty, opts ...grpc.CallOption) (*proto.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(proto.Empty)
	err := c.cc.Invoke(ctx, Daemon_ReloadConfig_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daemonClient) AddPeer(ctx context.Context, in *AddPeerParams, opts ...grpc.CallOption) (*AddPeerResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AddPeerResp)
	err := c.cc.Invoke(ctx, Daemon_AddPeer_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DaemonServer interface {
	...
	StreamEvents(*proto.Empty, grpc.ServerStreamingServer[Event]) error
...
func (UnimplementedDaemonServer) StreamEvents(*proto.Empty, grpc.ServerStreamingServer[Event]) error {
...
func _Daemon_StreamEvents_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(DaemonServer).StreamEvents(m, &grpc.GenericServerStream[proto.Empty, Event]{ServerStream: stream})
}
