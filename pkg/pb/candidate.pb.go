...
const (
	CandidatePairState_CANDIDATE_PAIR_STATE_UNSPECIFIED CandidatePairState = 0
	// CandidatePairStateWaiting means a check has not been performed for
	// this pair
	CandidatePairState_CANDIDATE_PAIR_STATE_WAITING CandidatePairState = 1
	// CandidatePairStateInProgress means a check has been sent for this pair,
	// but the transaction is in progress.
	CandidatePairState_CANDIDATE_PAIR_STATE_INPROGRESS CandidatePairState = 2
	...
	// failure response.
	CandidatePairState_CANDIDATE_PAIR_STATE_FAILED CandidatePairState = 3
	// CandidatePairStateSucceeded means a check for this pair was already
	// done and produced a successful result.
	CandidatePairState_CANDIDATE_PAIR_STATE_SUCCEEDED CandidatePairState = 4
)

// Enum value maps for CandidatePairState.
var (
	CandidatePairState_name = map[int32]string{
		0: "CANDIDATE_PAIR_STATE_UNSPECIFIED",
		1: "CANDIDATE_PAIR_STATE_WAITING",
		2: "CANDIDATE_PAIR_STATE_INPROGRESS",
		3: "CANDIDATE_PAIR_STATE_FAILED",
		4: "CANDIDATE_PAIR_STATE_SUCCEEDED",
	}
	CandidatePairState_value = map[string]int32{
		"CANDIDATE_PAIR_STATE_UNSPECIFIED": 0,
		"CANDIDATE_PAIR_STATE_WAITING":     1,
		"CANDIDATE_PAIR_STATE_INPROGRESS":  2,
		"CANDIDATE_PAIR_STATE_FAILED":      3,
		"CANDIDATE_PAIR_STATE_SUCCEEDED":   4,
	}
)
...
const (
	...
	NetworkType_NETWORK_TYPE_UDP4        NetworkType = 1
	NetworkType_NETWORK_TYPE_UDP6        NetworkType = 2
	NetworkType_NETWORK_TYPE_TCP4        NetworkType = 3
	NetworkType_NETWORK_TYPE_TCP6        NetworkType = 4
)
...
const (
	TCPType_TCP_TYPE_UNSPECIFIED       TCPType = 0
	TCPType_TCP_TYPE_ACTIVE            TCPType = 1
	TCPType_TCP_TYPE_PASSIVE           TCPType = 2
	TCPType_TCP_TYPE_SIMULTANEOUS_OPEN TCPType = 3
)
...
func (TCPType) Descriptor() protoreflect.EnumDescriptor {
	return file_candidate_proto_enumTypes[3].Descriptor()
}

func (TCPType) Type() protoreflect.EnumType {
	return &file_candidate_proto_enumTypes[3]
}
...
type Candidate struct {
	...
	Type        CandidateType `protobuf:"varint,1,opt,name=type,proto3,enum=wice.CandidateType" json:"type,omitempty"`
	NetworkType NetworkType   `protobuf:"varint,2,opt,name=network_type,json=networkType,proto3,enum=wice.NetworkType" json:"network_type,omitempty"`
	TcpType     TCPType       `protobuf:"varint,3,opt,name=tcp_type,json=tcpType,proto3,enum=wice.TCPType" json:"tcp_type,omitempty"`
...
func (x *Candidate) GetTcpType() TCPType {
	...
	return TCPType_TCP_TYPE_UNSPECIFIED
}
...
type CandidatePairStats struct {
	...
	State CandidatePairState `protobuf:"varint,4,opt,name=state,proto3,enum=wice.CandidatePairState" json:"state,omitempty"`
	...
	LastPacketSentTimestamp *Timestamp `protobuf:"bytes,10,opt,name=last_packet_sent_timestamp,json=lastPacketSentTimestamp,proto3" json:"last_packet_sent_timestamp,omitempty"`
	...
	LastPacketReceivedTimestamp *Timestamp `protobuf:"bytes,11,opt,name=last_packet_received_timestamp,json=lastPacketReceivedTimestamp,proto3" json:"last_packet_received_timestamp,omitempty"`
	// FirstRequestTimestamp represents the timestamp at which the first STUN request
	// was sent on this particular candidate pair.
	FirstRequestTimestamp *Timestamp `protobuf:"bytes,12,opt,name=first_request_timestamp,json=firstRequestTimestamp,proto3" json:"first_request_timestamp,omitempty"`
	...
	LastRequestTimestamp *Timestamp `protobuf:"bytes,13,opt,name=last_request_timestamp,json=lastRequestTimestamp,proto3" json:"last_request_timestamp,omitempty"`
	...
	LastResponseTimestamp *Timestamp `protobuf:"bytes,14,opt,name=last_response_timestamp,json=lastResponseTimestamp,proto3" json:"last_response_timestamp,omitempty"`
	...
	CurrenTroundtripTime float64 `protobuf:"fixed64,16,opt,name=curren_troundtrip_time,json=currenTroundtripTime,proto3" json:"curren_troundtrip_time,omitempty"`
	...
	ConsentExpiredTimestamp *Timestamp `protobuf:"bytes,27,opt,name=consent_expired_timestamp,json=consentExpiredTimestamp,proto3" json:"consent_expired_timestamp,omitempty"`
}
...
func (x *CandidatePairStats) GetTimestamp() *Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
func (x *CandidatePairStats) GetState() CandidatePairState {
	...
	return CandidatePairState_CANDIDATE_PAIR_STATE_UNSPECIFIED
}
...
func (x *CandidatePairStats) GetLastPacketSentTimestamp() *Timestamp {
	if x != nil {
...
func (x *CandidatePairStats) GetLastPacketReceivedTimestamp() *Timestamp {
	if x != nil {
...
func (x *CandidatePairStats) GetFirstRequestTimestamp() *Timestamp {
	if x != nil {
...
func (x *CandidatePairStats) GetLastRequestTimestamp() *Timestamp {
	if x != nil {
...
func (x *CandidatePairStats) GetLastResponseTimestamp() *Timestamp {
	if x != nil {
...
func (x *CandidatePairStats) GetConsentExpiredTimestamp() *Timestamp {
	if x != nil {
...
type CandidateStats struct {
	...
	NetworkType NetworkType `protobuf:"varint,3,opt,name=network_type,json=networkType,proto3,enum=wice.NetworkType" json:"network_type,omitempty"`
	...
	CandidateType CandidateType `protobuf:"varint,6,opt,name=candidate_type,json=candidateType,proto3,enum=wice.CandidateType" json:"candidate_type,omitempty"`
	...
	RelayProtocol string `protobuf:"bytes,9,opt,name=relay_protocol,json=relayProtocol,proto3" json:"relay_protocol,omitempty"`
...
func (x *CandidateStats) GetTimestamp() *Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
func (x *CandidateStats) GetRelayProtocol() string {
	if x != nil {
...
var file_candidate_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x5f, 0x0a, 0x0d, 0x43, 0x61, 0x6e, 0x64, 0x69, 0x64, 0x61,
	0x74, 0x65, 0x50, 0x61, 0x69, 0x72, 0x12, 0x25, 0x0a, 0x05, 0x6c, 0x6f, 0x63, 0x61, 0x6c, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x77, 0x69, 0x63, 0x65, 0x2e, 0x43, 0x61, 0x6e,
	0x64, 0x69, 0x64, 0x61, 0x74, 0x65, 0x52, 0x05, 0x6c, 0x6f, 0x63, 0x61, 0x6c, 0x12, 0x27, 0x0a,
	0x06, 0x72, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e,
	0x77, 0x69, 0x63, 0x65, 0x2e, 0x43, 0x61, 0x6e, 0x64, 0x69, 0x64, 0x61, 0x74, 0x65, 0x52, 0x06,
	0x72, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x22, 0x3e, 0x0a, 0x0e, 0x52, 0x65, 0x6c, 0x61, 0x74, 0x65,
	...
	,
	...
	,
	...
	0x65, 0x73, 0x52, 0x65, 0x63, 0x65, 0x69, 0x76, 0x65, 0x64, 0x12, 0x4c, 0x0a, 0x1a, 0x6c, 0x61,
	0x73, 0x74, 0x5f, 0x70, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x5f, 0x73, 0x65, 0x6e, 0x74, 0x5f, 0x74,
	0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f,
	0x2e, 0x77, 0x69, 0x63, 0x65, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x52,
	0x17, 0x6c, 0x61, 0x73, 0x74, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x53, 0x65, 0x6e, 0x74, 0x54,
	0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x12, 0x54, 0x0a, 0x1e, 0x6c, 0x61, 0x73, 0x74,
	...
	0x70, 0x52, 0x1b, 0x6c, 0x61, 0x73, 0x74, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x52, 0x65, 0x63,
	0x65, 0x69, 0x76, 0x65, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x12, 0x47,
	0x0a, 0x17, 0x66, 0x69, 0x72, 0x73, 0x74, 0x5f, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x5f,
	...
	0x52, 0x15, 0x66, 0x69, 0x72, 0x73, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x54, 0x69,
	0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x12, 0x45, 0x0a, 0x16, 0x6c, 0x61, 0x73, 0x74, 0x5f,
	0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d,
	0x70, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x77, 0x69, 0x63, 0x65, 0x2e, 0x54,
	0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x52, 0x14, 0x6c, 0x61, 0x73, 0x74, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x12, 0x47,
	0x0a, 0x17, 0x6c, 0x61, 0x73, 0x74, 0x5f, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x5f,
	...
	,
	...
	0x74, 0x12, 0x3a, 0x0a, 0x0e, 0x63, 0x61, 0x6e, 0x64, 0x69, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x74,
	0x79, 0x70, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x13, 0x2e, 0x77, 0x69, 0x63, 0x65,
	0x2e, 0x43, 0x61, 0x6e, 0x64, 0x69, 0x64, 0x61, 0x74, 0x65, 0x54, 0x79, 0x70, 0x65, 0x52, 0x0d,
	0x63, 0x61, 0x6e, 0x64, 0x69, 0x64, 0x61, 0x74, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12, 0x1a, 0x0a,
	...
	,
	...
	,
	...
	,
...
var file_candidate_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_candidate_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_candidate_proto_goTypes = []interface{}{
	(CandidatePairState)(0),    // 0: wice.CandidatePairState
	(CandidateType)(0),         // 1: wice.CandidateType
	(NetworkType)(0),           // 2: wice.NetworkType
	(TCPType)(0),               // 3: wice.TCPType
	(*CandidatePair)(nil),      // 4: wice.CandidatePair
	(*RelatedAddress)(nil),     // 5: wice.RelatedAddress
	(*Candidate)(nil),          // 6: wice.Candidate
	(*CandidatePairStats)(nil), // 7: wice.CandidatePairStats
	(*CandidateStats)(nil),     // 8: wice.CandidateStats
	(*Timestamp)(nil),          // 9: wice.Timestamp
}
var file_candidate_proto_depIdxs = []int32{
	6,  // 0: wice.CandidatePair.local:type_name -> wice.Candidate
	6,  // 1: wice.CandidatePair.remote:type_name -> wice.Candidate
	1,  // 2: wice.Candidate.type:type_name -> wice.CandidateType
	2,  // 3: wice.Candidate.network_type:type_name -> wice.NetworkType
	3,  // 4: wice.Candidate.tcp_type:type_name -> wice.TCPType
	5,  // 5: wice.Candidate.related_address:type_name -> wice.RelatedAddress
	9,  // 6: wice.CandidatePairStats.timestamp:type_name -> wice.Timestamp
	0,  // 7: wice.CandidatePairStats.state:type_name -> wice.CandidatePairState
	9,  // 8: wice.CandidatePairStats.last_packet_sent_timestamp:type_name -> wice.Timestamp
	9,  // 9: wice.CandidatePairStats.last_packet_received_timestamp:type_name -> wice.Timestamp
	9,  // 10: wice.CandidatePairStats.first_request_timestamp:type_name -> wice.Timestamp
	9,  // 11: wice.CandidatePairStats.last_request_timestamp:type_name -> wice.Timestamp
	9,  // 12: wice.CandidatePairStats.last_response_timestamp:type_name -> wice.Timestamp
	9,  // 13: wice.CandidatePairStats.consent_expired_timestamp:type_name -> wice.Timestamp
	9,  // 14: wice.CandidateStats.timestamp:type_name -> wice.Timestamp
	2,  // 15: wice.CandidateStats.network_type:type_name -> wice.NetworkType
	1,  // 16: wice.CandidateStats.candidate_type:type_name -> wice.CandidateType
