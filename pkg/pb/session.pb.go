...
func (x *SessionDescription) GetEpoch() int64 {
	if x != nil {
		return x.Epoch
	}
	return 0
...
func (x *SessionDescription) GetLite() bool {
	if x != nil {
		return x.Lite
	}
	return false
...
func (x *SessionDescription) GetUfrag() string {
	if x != nil {
		return x.Ufrag
	}
	return ""
...
func (x *SessionDescription) GetPwd() string {
	if x != nil {
		return x.Pwd
	}
	return ""
...
func (x *SessionDescription) GetCandidates() []*Candidate {
	if x != nil {
		return x.Candidates
	}
	return nil
...
var file_session_proto_rawDesc = []byte{
	...
	0x04, 0x77, 0x69, 0x63, 0x65, 0x1a, 0x0f, 0x63, 0x61, 0x6e, 0x64, 0x69, 0x64, 0x61, 0x74, 0x65,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x92, 0x01, 0x0a, 0x12, 0x53, 0x65, 0x73, 0x73, 0x69,
	...
	0x6f, 0x63, 0x68, 0x12, 0x12, 0x0a, 0x04, 0x6c, 0x69, 0x74, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x04, 0x6c, 0x69, 0x74, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x75, 0x66, 0x72, 0x61, 0x67,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x75, 0x66, 0x72, 0x61, 0x67, 0x12, 0x10, 0x0a,
	0x03, 0x70, 0x77, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x70, 0x77, 0x64, 0x12,
	0x2a, 0x0a, 0x0a, 0x63, 0x61, 0x6e, 0x64, 0x69, 0x64, 0x61, 0x74, 0x65, 0x73, 0x18, 0x05, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x0a, 0x2e, 0x43, 0x61, 0x6e, 0x64, 0x69, 0x64, 0x61, 0x74, 0x65, 0x52,
	0x0a, 0x63, 0x61, 0x6e, 0x64, 0x69, 0x64, 0x61, 0x74, 0x65, 0x73, 0x42, 0x16, 0x5a, 0x14, 0x72,
...
var file_session_proto_goTypes = []interface{}{
	(*SessionDescription)(nil), // 0: wice.SessionDescription
	(*Candidate)(nil),          // 1: Candidate
}
var file_session_proto_depIdxs = []int32{
	1, // 0: wice.SessionDescription.candidates:type_name -> Candidate
